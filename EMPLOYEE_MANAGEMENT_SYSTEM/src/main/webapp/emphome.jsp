 ...
 <center><h2>EMPLOYEE MANAGEMENT SYSTEM</h2></center>
    ...
    <br>
      <center> 
            ...
            <h3>Welcome to Employee Home Page</h3>
           
        </center>
        <br>
        <center><a href="search.html" style="font-size: large;"><h4>ShowDetails</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <a href="update.html" style="font-size: large;">Update</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="delete.html" style="font-size: large;">Delete</a></center>
